...
string  masspoint[13]={"600","800","1000","1200","1400","1600","1800","2000","2500","3000","3500","4000","4500"};
  ...
  for(Long64_t jEntry=0; jEntry<data.GetEntriesFast() ;jEntry++){
	...
	if (checkMyEle)continue;
        if (jetPRmass[ij]<20||jetPRmass[ij]>220)continue;
  ...
  TFile* outFile = new TFile(Form("root_filesPR/%s.root",endfix.Data()),"recreate");       
