...
void drawSameOPPR0817(){
	c1 = new TCanvas("c1","",1360,768);
	string  masspoint[13]={"600","800","1000","1200","1400","1600","1800","2000","2500","3000","3500","4000","4500"};
  for (int massP=0;massP<13;massP++){
	  
	  TString fin =Form("root_filesPR/signal-%s.root",masspoint[massP].data()),
      fin2 = Form("root_filesPR/BulkGravitonZlepZqq-%s.root",masspoint[massP].data()),
      fin3=Form("root_filesPR/DYHTall-%s.root",masspoint[massP].data());
	  ...
	  th1->SetMaximum(th1->GetMaximum()>th2->GetMaximum()?th1->GetMaximum():th2->GetMaximum()*1.1);
	  th1->Draw("hist,e");
	  th3->Draw("same,hist,e");
  ...
  setLeg(leg);
   ...
   leg->AddEntry(th3,"BG");
   leg->Draw("same");
   if(massP==0)c1->Print("pdfPR/drawSameOPv1.pdf(");
   else if (massP==12)c1->Print("pdfPR/drawSameOPv1.pdf)");
   else c1->Print("pdfPR/drawSameOPv1.pdf");
